...
public class DatabaseContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        var fakerBook = new Faker<Book>("pt_BR")
            ...
            .RuleFor(o => o.Isbn, faker => "ISBN_" + faker.Random.Guid())
            .RuleFor(o => o.Quantity, f => 41)
            .RuleFor(o => o.MinQuantityAllowed, f => 40)
        ...
        var fakeUsers = fakerUser.Generate(3);
        ...
        var fakeLoans = fakerLoan.Generate(3);
